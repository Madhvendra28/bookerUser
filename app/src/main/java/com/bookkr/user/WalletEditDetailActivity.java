...
public class WalletEditDetailActivity extends AppCompatActivity implements Response.Listener<String>, Response.ErrorListener, AdapterView.OnItemSelectedListener {
    ...
    List<WalletEditDetailActivity.Wallet> wallets;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wallet_edit_detail);
        activity = this;
...
*/
          ...
          /*  if (updatingImage) {
            ...
            new WalletEditDetailActivity.UploadFileHTTPAsync().execute(parameter);
    ...
    private class UploadFileHTTPAsync extends AsyncTask<RequestParameter, Void, String> {
        ...
        protected String doInBackground(RequestParameter... reqParams) {
            ...
            try {
                ...
                final String token = ShPrefUserDetails.getToken(WalletEditDetailActivity.this);
            ...
            switch (requestFor) {
                case 1:
                    try {
                        ...
                        wallets.add(new WalletEditDetailActivity.Wallet("0", "", "", "---Select Wallet---"));

                        for (int i = 0; i < jsonArray.length(); i++) {
                            JSONObject obj = jsonArray.getJSONObject(i);
                            WalletEditDetailActivity.Wallet wallet = new WalletEditDetailActivity.Wallet();
