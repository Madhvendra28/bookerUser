...
import com.fragment.OrderHistoryListViewFragment;
...
public class OrderHistoryActivity extends AppCompatActivity implements ObservableScrollViewCallbacks {
    ...
    private static OrderHistoryActivity activity;

    private ArrayList<String> sliderTitleList;
    private HashMap<String, ArrayList<ShipOrderDetails>> listHashMap;
    private ShipOrderDetails selectedShipOrderDetails;
    ...
    private void getOrderHistoryList() {
        try {
            ...
            parameter.setUri(AppURL.getAppURL() + AppURL.getUserShippingHistory());
    ...
    private void processResponse(JSONObject jsonObject) {
        try {
            ...
            listHashMap = JSONParser.parseAllShipOrderDetailsMap(jsonArray);
...
//                    propagateToolbarState(toolbarIsShown());
    ...
    public static OrderHistoryActivity getActivity() {
        return activity;
    }
    ...
    private static class MyPagerAdapter extends CacheFragmentStatePagerAdapter {
        ...
        protected Fragment createItem(int position) {
            Fragment f = new OrderHistoryListViewFragment();
            Bundle args = new Bundle();
            args.putInt(OrderHistoryListViewFragment.ARG_TAB_INDEX, position);
            if (0 < mScrollY) {
                args.putInt(OrderHistoryListViewFragment.ARG_INITIAL_POSITION, 1);
            }
            f.setArguments(args);
        ...
        public CharSequence getPageTitle(int position) {
            ...
            if (s.equalsIgnoreCase(AppURLParams.statusVal0)) {
                return activity.getString(R.string.status_shipped);

            } else if (s.equalsIgnoreCase(AppURLParams.statusVal1) || s.equalsIgnoreCase(AppURLParams.statusVal2) || s.equalsIgnoreCase(AppURLParams.statusVal3)
                    || s.equalsIgnoreCase(AppURLParams.statusVal4) || s.equalsIgnoreCase(AppURLParams.statusVal5) || s.equalsIgnoreCase(AppURLParams.statusVal7)
                    || s.equalsIgnoreCase(AppURLParams.statusVal8)) {
                return activity.getString(R.string.status_active);

            }else if (s.equalsIgnoreCase(AppURLParams.statusVal6)) {
                return activity.getString(R.string.status_history);
    ...
    public ArrayList<String> getSliderTitleList() {
        return sliderTitleList;
    }

    public HashMap<String, ArrayList<ShipOrderDetails>> getListHashMap() {
        return listHashMap;
    }

    public void setSelectedShipOrderDetails(ShipOrderDetails selectedShipOrderDetails) {
        this.selectedShipOrderDetails = selectedShipOrderDetails;
    }

    public ShipOrderDetails getSelectedShipOrderDetails() {
        return selectedShipOrderDetails;
    }
