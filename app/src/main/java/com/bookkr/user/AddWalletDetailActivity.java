...
public class AddWalletDetailActivity extends AppCompatActivity implements Response.Listener<String>, Response.ErrorListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_wallet_detail);
        activity = this;
...
//                        requestPermissions(new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 0);
    ...
    private void addMoreUPId() {
        ...
        EditText edtUpiID = view.findViewById(R.id.edtUpiID);
        edtUpiID.setText(edtUpiID.getText().toString().split("@")[0] + wallets.get(spinnerWallet.getSelectedItemPosition()).getId_end());
    ...
    private class UploadFileHTTPAsync extends AsyncTask<RequestParameter, Void, String> {
        ...
        protected String doInBackground(RequestParameter... reqParams) {
            ...
            try {
                ...
                final String token = ShPrefUserDetails.getToken(AddWalletDetailActivity.this);
