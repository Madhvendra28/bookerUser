...
public class BankDetailEditActivity extends AppCompatActivity implements Response.Listener<String>, Response.ErrorListener, AdapterView.OnItemSelectedListener {
    String id, type;
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (spinnerAccountOf.getTag().equals("notNull")) {
                    ...
                    if (spinnerAccountOf.getSelectedItemPosition() == 1) {
                        edtAccountHolderName.setText(ShPrefUserDetails.getName(BankDetailEditActivity.this));
