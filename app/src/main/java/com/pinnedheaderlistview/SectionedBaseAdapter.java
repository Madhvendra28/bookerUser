...
public abstract class SectionedBaseAdapter extends BaseAdapter implements PinnedHeaderListView.PinnedSectionedHeaderAdapter {
    ...
    public final View getView(int position, View convertView, ViewGroup parent)  {
        try {
            ...
            if(getCallOrNotForSectionItem(getSectionForPosition(position), getPositionInSectionForPosition(position))) {
                View view = getItemView(getSectionForPosition(position), getPositionInSectionForPosition(position), convertView, parent);
                return view;
            }else
                return convertView;
        }catch (Exception e){
...
//        Log.d("cachedSection size", mSectionCache.size()+ "");
//        Log.d("cachedSection val", cachedSection+ "");
...
//                Log.d("new in msectioncache",i + "");
    ...
    public abstract boolean getCallOrNotForSectionItem(int section,int position);
