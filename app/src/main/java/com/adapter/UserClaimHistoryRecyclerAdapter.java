...
public class UserClaimHistoryRecyclerAdapter extends RecyclerView.Adapter<UserClaimHistoryRecyclerAdapter.ViewHolder> {
    private static final String TAG = "PostReqRecyclerAdapter";
    private List<PostRequirement> list;
    private Context context;

    public UserClaimHistoryRecyclerAdapter(Context context, ArrayList<PostRequirement> list) {
        this.context = context;
        this.list = list;
    }

    @Override
    public UserClaimHistoryRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_post_req_item_layout, parent, false);
        return new UserClaimHistoryRecyclerAdapter.ViewHolder(view);
    }
...
//                    Spconstant.isForClaimorUpdate =true;
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView adapter_imageview_req_Image; //, adapter_imageview_action_star;
        private TextView adapter_textview_claimed, adapter_textview_total_quantity, adapter_textview_claim_available_tag,
                ...
                adapter_textview_dealer_name; //, adapter_textview_varient, , adapter_textview_shop_name,
        //                adapter_textview_rating;
