...
public class UserClaimConfirmSiteDataRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Activity activity;
    private ArrayList<SiteData> list;

    public UserClaimConfirmSiteDataRecyclerAdapter(Activity activity, ArrayList<SiteData> siteData) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private void bindProductListItems(UserClaimConfirmSiteDataRecyclerAdapter adapter, final int position) {
            try {
                ...
                if (siteData.isChecked()) {
                    ((UserClaimConfirmActivity) activity).setFragmentForSite(siteData);
                }
